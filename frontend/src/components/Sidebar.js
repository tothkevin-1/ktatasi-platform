...
const Sidebar = () => {
    ...
    return (
        <Box sx={{ position: { md: 'sticky' }, top: { md: '20px' } }}>
            ...
            <Paper elevation={4} sx={{ p: 3, mb: 3, textAlign: 'center', background: 'linear-gradient(135deg, #FFD700 0%, #FDB931 100%)', color: '#000', borderRadius: 3 }}>
                <WorkspacePremiumIcon sx={{ fontSize: 50, mb: 1, color: '#fff' }} />
                <Typography variant="h6" fontWeight="bold" textTransform="uppercase">{t('ev_diakja')}</Typography>
                
                <Avatar sx={{ width: 64, height: 64, margin: '10px auto', bgcolor: '#fff', color: '#000', fontSize: '1.5rem', fontWeight: 'bold' }}>
            ...
            <Paper elevation={3} sx={{ p: 3, textAlign: 'center', background: 'linear-gradient(135deg, #E0E0E0 0%, #BDBDBD 100%)', color: '#000', borderRadius: 3 }}>
                <EmojiEventsIcon sx={{ fontSize: 40, mb: 1, color: '#fff' }} />
                <Typography variant="subtitle1" fontWeight="bold" textTransform="uppercase">{t('honap_diakja')}</Typography>
                
                <Avatar sx={{ width: 50, height: 50, margin: '10px auto', bgcolor: '#fff', color: '#000', fontWeight: 'bold' }}>
